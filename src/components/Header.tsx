...
export function Header({ themeConfig, meta }: HeaderProps) {
    ...
    const siteName = themeConfig?.siteName || '网站名称'
        ...
        <>
            <header className="fixed top-0 left-0 right-0 z-50">
                <nav className="bg-white/80 dark:bg-dark-secondary/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
                                    ...
                                    {menuItems.map((item: MenuItem) => {
                                        ...
                                        if (item.type === 'menu' && item.items) {
                                            ...
                                            return (
                                                <div key={item.route} className="relative group px-1 lg:px-2">
                                                    <button 
                                                        className={`flex flex-col items-center justify-center h-16 md:h-20 px-2 lg:px-3 border-b-2 ${
                                                            isActive
                                        ...
                                        return (
                                            <Link
                                                ...
                                                className={`flex flex-col items-center justify-center h-16 md:h-20 px-2 lg:px-3 mx-1 lg:mx-2 border-b-2 ${
                                                    isActive
                                                        ? 'border-primary-500 dark:border-primary-400 text-primary-500 dark:text-primary-400'
                                                        : 'border-transparent text-theme-text-secondary hover:text-primary-500 dark:hover:text-primary-400'
                                                } transition-colors`}
                    ...
                    <div 
                        id="mobile-menu"
                        className={`md:hidden fixed inset-x-0 top-16 bottom-0 bg-theme-bg-primary dark:bg-dark transform transition-transform duration-300 ease-in-out ${
                                    ...
                                    if (item.type === 'menu' && item.items) {
                                        return (
                                            <div key={item.route} className="space-y-1">
                                                <div className="flex items-center px-3 py-2 text-theme-text-primary font-medium">
                                                    {item.icon && (
